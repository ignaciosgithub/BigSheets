...
try:
    ...
    print("Successfully imported FunctionManager from src.bigsheets")
except ImportError:
    print("Failed to import from src.bigsheets, trying direct import")
    ...
    function_manager_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(function_manager_module)
    FunctionManager = function_manager_module.FunctionManager
    print("Successfully imported FunctionManager using direct import")
